...
// Home.jsx 최상단 또는 별도 상수 관리 파일에 배치
const JAVA_CHAPTERS = {
  // ========================================================
  // 1. 기초 단계 (unit_level: '기초')
  // ========================================================
  basic: [
    {
      id: "basic_ch1",
      title: "1단원: 변수와 자료형",
      description: "Java 프로그래밍의 시작인 변수 선언, 메모리 저장 방식 및 자료형 변환을 배웁니다.",
      icon: "💽",
      // 💡 Supabase의 'unit' 컬럼값과 정확히 일치해야 실시간 진도율이 정산됩니다.
      units: ["기본 프로그래밍 환경과 실행", "변수와 자료형", "타입 확인과 변환", "형변환"]
    },
    {
      id: "basic_ch2",
      title: "2단원: 연산자와 제어문",
      description: "다양한 연산자로 데이터를 가공하고, 조건문과 반복문으로 프로그램의 흐름을 제어합니다.",
      icon: "🔀",
      units: ["산술 및 비교 연산자", "조건문(if, switch)", "반복문(for, while)", "연산자와 제어문", "조건문과 반복문"]
    },
    {
      id: "basic_ch3",
      title: "3단원: 배열과 문자열",
      description: "대량의 데이터를 효율적으로 구조화하는 배열과 자바의 핵심 데이터인 String 문자열을 마스터합니다.",
      icon: "📚",
      units: ["1차원 및 다차원 배열", "String 클래스와 주요 메서드", "배열과 문자열"]
    }
  ],

  // ========================================================
  // 2. 중급 단계 (unit_level: '중급')
  // ========================================================
  mid: [
    {
      id: "mid_ch1",
      title: "1단원: 객체지향 프로그래밍 (OOP)",
      description: "자바의 본질인 객체지향의 4대 특징(캡슐화, 상속, 다형성, 추상화)과 클래스 구조를 완성합니다.",
      icon: "🏗️",
      units: ["객체지향 프로그래밍 입문", "캡슐화와 접근제한자", "상속과 다형성", "추상 클래스와 인터페이스", "클래스와 객체"]
    },
    {
      id: "mid_ch2",
      title: "2단원: 예외 처리 및 기본 패키지",
      description: "프로그램의 예기치 못한 에러를 안정적으로 제어하고, 자바가 기본 제공하는 핵심 API를 활용합니다.",
      icon: "🛡️",
      units: ["예외 처리(Exception)", "try-catch-finally", "java.lang.Object 클래스", "Wrapper 클래스"]
    },
    {
      id: "mid_ch3",
      title: "3단원: 자바 컬렉션 프레임워크",
      description: "실무에서 가장 많이 쓰는 가변 자료구조 리스트(List), 셋(Set), 맵(Map)을 다룹니다.",
      icon: "🗃️",
      units: ["List 계열(ArrayList)", "Set 계열(HashSet)", "Map 계열(HashMap)", "자바 컬렉션 프레임워크"]
    }
  ],

  // ========================================================
  // 3. 고급 단계 (unit_level: '고급')
  // ========================================================
  adv: [
    {
      id: "adv_ch1",
      title: "1단원: 제네릭과 모던 자바 사양",
      description: "타입 안정성을 높이는 제네릭과 모던 자바의 꽃인 람다식, 스트림 API를 학습합니다.",
      icon: "⚡",
      units: ["제네릭스(Generics)", "함수형 인터페이스와 람다식", "스트림 API", "Optional 클래스"]
    },
    {
      id: "adv_ch2",
      title: "2단원: 멀티 스레드 및 JVM 내부 구조",
      description: "동시에 여러 작업을 처리하는 다중 스레드 환경과 JVM 메모리(Heap, Stack) 관리 아키텍처를 파헤칩니다.",
      icon: "⚙️",
      units: ["멀티 스레드와 동시성", "스레드 동기화", "JVM 메모리 구조", "가비지 컬렉션(GC)"]
    },
    {
      id: "adv_ch3",
      title: "3단원: 입출력 시스템 및 네트워크",
      description: "스트림 기반의 파일 입출력(I/O) 데이터 전송과 소켓 프로그래밍을 통한 네트워크 기초를 다집니다.",
      icon: "🌐",
      units: ["입출력 스트림(I/O)", "네트워크 소켓 프로그래밍"]
    }
  ]
};
