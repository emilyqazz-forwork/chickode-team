...
export const translations = {
    ko: {
        ...
        quiz_obj: "객관식",
        quiz_subj: "주관식",
        quiz_count: "문제 수 (1~10)",
        quiz_count_max_hint: "문제는 최대 10개까지 가능해요.",
        quiz_count_min_hint: "최소 1문제부터 시작할 수 있어요.",
        quiz_diff: "난이도",
        diff_easy: "하 (Easy)",
        ...
        tutorial_menu_body: "문제풀기, 오답노트, 학습지표, 미니게임을 여기서 시작할 수 있어요.",
    ...
    en: {
        ...
        quiz_obj: "MCQ",
        quiz_subj: "Coding",
        quiz_count: "Questions (1~10)",
        quiz_count_max_hint: "You can take up to 10 questions maximum.",
        quiz_count_min_hint: "You need at least 1 question to start.",
